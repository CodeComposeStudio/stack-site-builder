...
import { productCategoryMap } from './data/product-categories';
import { paperCategoryMap } from './data/paper-categories';
...
export const collections = defineAasCollections({ categoryMap, courseCategoryMap, productCategoryMap, paperCategoryMap });
